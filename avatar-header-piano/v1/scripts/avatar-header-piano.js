...
if (tagSite) {
	...
	if (window.matchMedia("(max-width: 767px)").matches) {
		divTag.setAttribute('style',"background-image: url("+imagemAvatarHeader+"); height: 22px; background-size: 20px; background-repeat: no-repeat; background-position-x: right");
	}
