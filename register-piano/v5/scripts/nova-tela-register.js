(function(){
    ...
    if (protectedContentEl) {
        ...
        let url = isProduction ? 'https://login.globo.com/' : 'https://login.qa.globoi.com/';
        let urlLogin = url + 'login/' + Piano.variaveis.getServicoId() + '?url=https%3A%2F%2Fs3.glbimg.com%2Fv1%2FAUTH_65d1930a0bda476ba8d3c25c5371ec3f%2Fpiano%2Fhelper%2Fredirect.html%23' + uri;
        let urlRegister = url + 'cadastro/' + Piano.variaveis.getServicoId() + '?url=https%3A%2F%2Fs3.glbimg.com%2Fv1%2FAUTH_65d1930a0bda476ba8d3c25c5371ec3f%2Fpiano%2Fhelper%2Fredirect.html%23' + uri;
        ...
        document.querySelector('#btnRegister').addEventListener('click', function(a) {
            ...
            setTimeout(function() { window.open(urlRegister); }, 200);
        });

        document.querySelector('.textLogin a').addEventListener('click', function(a) {
            a.preventDefault();
            setTimeout(function() { window.open(urlLogin); }, 200);
        ...
        document.querySelector('#offerLink').addEventListener('click', function(a) {
            ...
            setTimeout(function() { window.open(finalUrl); }, 200);
        });
