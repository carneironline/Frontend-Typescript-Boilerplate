...
"				<img class='img-desk' src='https://static"+Piano.util.montaUrlStg()+".infoglobo.com.br/paywall/register-piano/v4/images/register-natal.jpg'>" +
"				<h2><span>APROVEITE A OFERTA</span><b>ESPECIAL DE NATAL</b></h2>" +
"				<p class='img-mobi'><span>ESPECIAL DE NATAL</span> <i>50% OFF POR 1 ANO</i></p>" +
"				<p class='img-desk'><span>A partir de </span><i>R$4,90 por mês</i></p>" +
"				<a href='https://assinatura.oglobo.globo.com/VitrineDigital.aspx' target='_blank'>Assine Já</a>" +
"			</div>" +
"		</div>" +
