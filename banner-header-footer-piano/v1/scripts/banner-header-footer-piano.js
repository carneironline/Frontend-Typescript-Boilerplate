if (window.linkAssinaturaHeaderFooter) {
	$("footer .footer #banner-assinatura-footer a, .top-header ul.menu-interacao>li#banner-assinatura a, .top-header ul.menu-interacao > li#banner-assinatura a, footer .bar .assine a").attr("href", linkAssinaturaHeaderFooter);
} else {
