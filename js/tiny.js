...
Piano.util = {
  ...
  recarregaPiano: function recarregaPiano(tipoConteudo, isExclusivo, nomeProduto) {
    ...
    window.nomeProdutoPiano = nomeProduto; // if (typeof window.regrasTiny !== 'undefined') {
