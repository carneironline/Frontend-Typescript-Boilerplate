    ...
    value: function createTemplate(element) {
      if (element) {
        if (element.firstChild.nodeValue === 'Fechar') {
          ...
          var paywallInline = document.querySelector("#".concat(this.paywallId));
