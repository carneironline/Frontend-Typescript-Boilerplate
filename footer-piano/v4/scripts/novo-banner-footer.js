...
"                                   <img alt='pacote 1' src='https://static"+Piano.util.montaUrlStg()+".infoglobo.com.br/paywall/footer-piano/v4/images/digital-premium-copy.png'>" +
"                               </li>" +
...
"                                   </a>" +
"                               </li>" +
"                               <li class='informacao-produto compartilha-cor'>Acesso ilimitado ao Site " +
...
"                                   <strong class='compartilha-cor'>R$ 14,90</strong>" +
...
"                           <ul>" +
"                               <li class='img-produto'>" +
"                                   <img alt='pacote 2' src='https://static"+Piano.util.montaUrlStg()+".infoglobo.com.br/paywall/footer-piano/v4/images/digital-copy.png'>" +
"                                   </li>" +
"                               <li class='titulo-produto'>" +
"                                   <div class='oglobo-logo'></div>" +
...
"                                   <strong class='compartilha-cor'>R$ 4,90</strong>" +
"                                   <small class='compartilha-cor'>" +
"                                       <span class='azul-medio'>/ MÊS</span>" +
"                                       <b>por 12 meses</b>" +
"                                   </small>" +
...
"                   <a class='chamada-telefone'><small>Televendas: 4002 5300</small></a>" +
"                   <h2 class='compartilha-cor'>" +
"                       <span class='assine-comeco'></span>" +
"                       <strong class='azul-medio'>BLACK FRIDAY</strong>" +
"                       <span class='assine-fim'>50% OFF POR 1 ANO<span>" +
"                   </h2>" +
"                   <span class='chamada-abre-oferta btn-default'>Assine agora</span>" +
"               </div>" +
"           </div>" +
"       </div>" +
"   </div>" +
