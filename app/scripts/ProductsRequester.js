...
export default function getProductsObject(environment, callback) {
    ...
    const prodJson = 'https://s3.glbimg.com/v1/AUTH_7b0a6df49895459fbafe49a96fcb5bbf/tiny/Prod/produtos.json'
    const qaJson = 'https://s3.glbimg.com/v1/AUTH_7b0a6df49895459fbafe49a96fcb5bbf/tiny/Hom/produtos.json'
    const finalURL = Tiny.isProduction ? prodJson : qaJson
